...
interface IDataframeScrollbarProps {
  dfProps: IDFProps
  onScroll: (e: UIEvent<HTMLDivElement>) => void
}

export const DataframeRightScroll = forwardRef(function DataframeRightScroll(
  { dfProps, onScroll }: IDataframeScrollbarProps,
...
export const DataframeBottomScroll = forwardRef(function DataframeBottomScroll(
  { dfProps, onScroll }: IDataframeScrollbarProps,
  ref: ForwardedRef<HTMLDivElement>
) {
  return (
...
export const DataFrameCanvas = forwardRef(function DataFrameCanvas(
  ...
  function drawCells(
    ...
    let py = (rowRange[0] + 0.5) * cellSize[1] - top + TEXT_OFFSET
